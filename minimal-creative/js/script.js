...
jQuery(function ($) {
    ...
    function gtag_report_conversion(btn, url) {
        ...
        switch(btn){
            case 'WhatsApp_Flutuante':
                gtag('event', 'conversion', {
                    'send_to': 'AW-10950657645/sglPCIPd0IMYEO2M1-Uo',
                    'event_callback': callback
                });
            break;
            case 'Facebook':
                gtag('event', 'conversion', {
                    'send_to': 'AW-10950657645/F3u7CKDoz4MYEO2M1-Uo',
                    'event_callback': callback
                });
            break;
            case 'Instagram':
                gtag('event', 'conversion', {
                    'send_to': 'AW-10950657645/mZtICLKwz4MYEO2M1-Uo',
                    'event_callback': callback
                });
            break;
            case 'WhatsApp':
                gtag('event', 'conversion', {
                    'send_to': 'AW-10950657645/wUBOCLP10IMYEO2M1-Uo',
                    'event_callback': callback
                });
            break;
            case 'LinkedIn':
                gtag('event', 'conversion', {
                    'send_to': 'AW-10950657645/hj5tCJXyz4MYEO2M1-Uo',
                    'event_callback': callback
                });
            break;
        }
    ...
    $("#whatsapp_flutuante").on('click', function(){
        gtag_report_conversion('WhatsApp_Flutuante');
    })
    $(".facebook_btn").on('click', function(){
        gtag_report_conversion('Facebook');
    })
    $(".whatsapp_btn").on('click', function(){
        gtag_report_conversion('WhatsApp');
    })
    $(".instagram_btn").on('click', function(){
        gtag_report_conversion('Instagram');
    })
    $(".linkedin_btn").on('click', function(){
        gtag_report_conversion('LinkedIn');
    })
});